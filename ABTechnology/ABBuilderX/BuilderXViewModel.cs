...
public class BuilderXViewModel : ViewModel
{
    ...
    public ViewModelList<BrushItem> PresetBackgroundBrushes => new()
{
    ...
    #region Page's 
    /// <summary>
    /// Get or set the main View were you do code 
    /// </summary>
    public static CodeBookPage? CoodeView { get; set; } = App.BuilderXHost!.Services.GetService<CodeBookPage>();
    /// <summary>
    /// The View for viewing Media like Video and Photo's
    /// </summary>
    public static MediaBookPage? MediaView { get; set; } = App.BuilderXHost!.Services.GetService<MediaBookPage>();
    /// <summary>
    /// Get or set the main View for Notes and Writting DOcuments 
    /// </summary>
    public static NotebookPage? NoteView { get; set; } = App.BuilderXHost!.Services.GetService<NotebookPage>();
    public static SketchBookPage? SketchView { get; set; } = App.BuilderXHost!.Services.GetService<SketchBookPage>();
    public static VideoBookPage? ViewoView { get; set; } = App.BuilderXHost!.Services.GetService<VideoBookPage>();
